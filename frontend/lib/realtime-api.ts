...
export type SessionRealtimeEvent = {
  type: "LIVE_STAGE_STATE" | "BUZZER_STATE" | "TIMER_STATE" | "WORD_CLOUD_STATE" | "WORD_CLOUD_PARTICIPANT_STATE" | "POLL_STATE" | "POLL_PARTICIPANT_STATE" | "PARTICIPANT_CONNECTED" | "PARTICIPANT_DISCONNECTED" | "SESSION_FINISHED" | "AUTH_OK" | "AUTH_REQUIRED" | "ERROR" | string;
  sessionId: string;
  occurredAt: string;
  payload: unknown;
};
